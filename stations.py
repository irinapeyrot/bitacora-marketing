...
# override de nombres cortos para pines de sección (los que no son punto/traducción)
SHORT_OVERRIDE = {
    'El territorio que todavía no pisé': 'Territorio sin pisar',
    'Lo que cambió en la mirada': 'Cambió la mirada',
}
for st in stations:
    if st['title'] in SHORT_OVERRIDE:
        st['short'] = SHORT_OVERRIDE[st['title']]
...
# ---- POSICIONES FIJAS (a mano + optimizadas): 25 pines en tierra firme,
#      separación mínima ~91px, SIN roces de ruta con pines ajenos,
#      distribuidos por todo el mapa (cobertura ~977x630).
HANDPOS = [
    (1020, 1210),
    (1003, 1321),
    (1150, 1410),
...
for st,(x,y) in zip(stations, HANDPOS):
