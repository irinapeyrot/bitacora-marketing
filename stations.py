...
# --------- posiciones sobre el mapa (zigzag compacto y regular) ---------
N = len(stations)
MW, MH = 3000, 2100
cx, cy = MW/2, MH/2
...
random.seed(11)
pts = []
# zigzag horizontal compacto: avanza parejo en X, ondas cortas en Y
x0, x1 = cx - 980, cx + 980
amp = 175
waves = 5.5
for i in range(N):
    ...
    y += (t - 0.5) * 110          # leve inclinación general
    x += random.uniform(-12, 12)  # jitter mínimo (hecho a mano, sin desorden)
