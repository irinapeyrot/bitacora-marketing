...
window.FIGURAS = {
  ...
  fig14: {
    ...
    lectura: 'La matriz combate el error más común: publicar siempre el mismo tipo de contenido. Marcas que solo venden (puro fondo de embudo) y se preguntan por qué nadie las sigue; o que solo entretienen y nunca convierten. Una comunidad sana necesita contenido de los cuatro cuadrantes, porque su audiencia está repartida en distintas etapas del embudo.'
  },
  ...
  figE8: {
    ...
    lectura: 'Hasta 2024, pocas marcas llenaban los cuatro cuadrantes sin recostarse solo en "convertir". Prex repartía: eventos y comunidad para entretener, historias para inspirar, educación financiera para educar y productos para convertir.'
  },
